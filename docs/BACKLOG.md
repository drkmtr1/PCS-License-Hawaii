...
| BL-003 | Implement claim/source/conflict schemas and integrity validation | R2 | FR-004, FR-006–007, AC-004–005 | schema and negative tests; 2 reviews + SHA gate | Candidate implemented and locally validated; pending 2 independent reviews and SHA-bound PR merge; observed records remain non-routable |
