...
| BL-002 | Select web stack; scaffold accessible shell and CI | R1 | NFR-001–010, UX-001 | build/lint/test/a11y/privacy/expiry checks; 2 reviews + SHA gate | Candidate implemented and locally validated; pending 2 independent reviews and SHA-bound PR merge; exposes only neutral non-guidance/unavailable states and no claims, rules, contacts, or questionnaire decisions |
