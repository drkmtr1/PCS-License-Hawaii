...
- **AC-007** Evaluation records 100% correct safety-critical assertions on approved cases, 100% abstention outside evidence, zero authorization claims, and at least 95% task completion before V1 release, with per-profession/route/subgroup results.
